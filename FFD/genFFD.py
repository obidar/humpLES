...
corners[0,0,:] = [-7.00,0.0000,0.1]     # lower left front
corners[0,1,:] = [-7.00,0.0000,0.0]     # lower left back
corners[0,2,:] = [-7.00,1.0000,0.1]     # upper left front
corners[0,3,:] = [-7.00,1.0000,0.0]     # upper left back 
corners[0,4,:] = [ 5.00,0.0000,0.1]     # lower right front
corners[0,5,:] = [ 5.00,0.0000,0.0]     # lower right back
corners[0,6,:] = [ 5.00,1.0000,0.1]     # upper right front
corners[0,7,:] = [ 5.00,1.0000,0.0]     # upper right back
